...
operator\_sdk\_tool\_path          | undefined                                            | Path to operator-sdk binary, optional. Please check roles/preflight/templates/example_preflight_config.yml for the example.
preflight\_operators\_to\_check    | undefined                                            | List of operators to be checked with Preflight Cert Suite. Please check roles/preflight/templates/example_preflight_config.yml for the example.
