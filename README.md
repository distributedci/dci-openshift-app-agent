...
master\_nodes\_names                 |                                                    | List of master nodes addresses (names or IPs), separated by spaces, to be accessed from the provisioner to gather logs with must-gather images. If not defined, logs will not be retrieved.
