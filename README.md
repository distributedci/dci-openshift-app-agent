...
```ShellSession
# su - dci-openshift-app-agent
$ dci-openshift-app-agent-ctl -- --tags job,pre-run,running,post-run
```
...
```ShellSession
# su - dci-openshift-app-agent
$ dci-openshift-app-agent-ctl -- --skip-tags testing
```
...
mandatory to initialize all the DCI specifics.
