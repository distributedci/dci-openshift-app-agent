...
test\_network\_function\_version   | HEAD                                                 | CNF Cert Suite version downloaded. The DCI OpenShift App Agent currently supports only the latest version, which is HEAD branch
