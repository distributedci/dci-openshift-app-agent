...
tnf\_suites                        | "diagnostic generic" | list of space separated [test suites](https://github.com/test-network-function/test-network-function#general). Note that, for versions until v2.0.0, you can execute the following test suites: diagnostic, generic, container, operator, multus. For versions higher than v2.0.0, you can execute the following tests: diagnostic, generic, access-control, networking, lifecycle, observability, platform, operator, affiliated-certification, multus
