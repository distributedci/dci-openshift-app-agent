...
preflight\_operators\_to\_check    | quay.io/rh-nfv-int/testpmd-operator-bundle:v0.2.9    | List of operators to be checked with preflight test suite.
preflight\_version                 | 0.0.0                                                | Preflight test suite version, here are [currently availale versions](https://quay.io/repository/opdev/preflight?tab=tags).
