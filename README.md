...
local\_registry                    | ""                                                   | registry to fetch containers that may be used. Must be set in disconnected environments.
local\_registry\_creds             | ""                                                   | path to the pull-secret.txt file to access to the registry. Must be set in disconnected environments.
