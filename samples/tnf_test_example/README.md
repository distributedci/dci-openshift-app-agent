...
- Specific SCC to be attached to all pods by using a ClusterRole, a ServiceAccount and a ClusterRoleBinding. This SCC is related to Verizon documentation, to follow best practices of how to deploy pods in a secure way.
