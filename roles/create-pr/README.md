# Create PR Role
This role groups the common tasks to create the GitHub Pull needed for the certification workflows.
...
github\_token\_path                 | undefined | true                        | GitHub token to be used to push the chart and the results to a repository. Defaults to [openshift-charts/charts](https://github.com/openshift-helm-charts/charts/)
...
#### Role workflow
After check tests has been executed in the preflight role on the operator,  the role can be called to create a PR which is needed in the certification workflow of an operator.
...
Check the README of 'the chart-verifier' role.