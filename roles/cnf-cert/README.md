...
Note that, to test operators with the operator test suite, it requires the following labels and annotations to be declared in the CSV under test:

* label: `test-network-function.com/operator=target`
* annotation: `test-network-function.com/operator_tests='["OPERATOR_STATUS"]'`
