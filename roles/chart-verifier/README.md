...
dci\_charts                        | undefined                                            | A list of charts with additional parameters to be used during testing. Example:<br><br>cv_dci_charts: <br>&nbsp;&nbsp;&nbsp; -<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; name: "<RELEASE_NAME>"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; chart: "http://xyz/chart.tgz" (required) <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; chart_values: "http://xyz/values.yaml" <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; flags: [See helm-chart-checks](https://github.com/redhat-certification/chart-verifier/blob/main/docs/helm-chart-checks.mds) for available flags.<br> * Charts deployment on an OCP cluster is not enabled at this moment.
