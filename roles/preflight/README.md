...
preflight\_binary                  | <https://github.com/redhat-openshift-ecosystem/openshift-preflight/releases/download/1.3.3/preflight-linux-amd64>              | Optional. [Version of Preflight Cert Suite to run check container cert suite](https://quay.io/repository/opdev/preflight?tab=tags)
preflight\_image                   | quay.io/opdev/preflight:1.3.3                                  | Optional. [Version of Preflight Cert Suite to run check operator cert suite](https://quay.io/repository/opdev/preflight?tab=tags)
