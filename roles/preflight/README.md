...
operator\_sdk\_tool\_path          | undefined                                            | Path to operator-sdk binary, optional. Please check [example_preflight_config.yaml](#example-of-config-file-to-define-a-list-of-operators-to-ceritfy) for the example.
...
preflight_operators_to_certify:
  ...
  - operator_image: "quay.io/opdev/simple-demo-operator-bundle:v0.0.3"
    pyxis_identifier: PROJECTID
