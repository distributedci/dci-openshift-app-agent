...
preflight_test_certified_image     | false                                                | If set to true, images that have been already certified will be tested again (expect the ones from the official Red Hat registry)
