...
- Component name will be the image version, being either image tag or SHA.
...
- Component canonical project name will be the agreed string: `POD_IMG <container_image_name> <container_image_version>`.
