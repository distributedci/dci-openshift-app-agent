...
| opcap_cleanup                  | false    | true                             | Cleanup the tmp directory where the binary is built. When set to false, the bin is copied into the opcap_output_dir                         |
