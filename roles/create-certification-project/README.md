...
create_custom_project_name | None                                                                     | Optional. Define if you want to create your own custom certification project name instead of using image name.
...
preflight_containers_to_certify:
  - container_image: "quay.io/my-container/bla-bla-image:v0.0.1"
    create_container_project: true
    #create_custom_project_name is optional when not wanted to customize the container project name
    create_custom_project_name: "my-custom-container-project-name"
